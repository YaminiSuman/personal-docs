...
function Header() {
  ...
  return (
    <header className="sticky top-0 z-0 flex items-center px-4 py-4 shadow-md bg-white">
      <Button
        color="gray"
        buttonType="outline"
        rounded={true}
      ...
      <div className="mx-5 md:mx-20 flex flex-grow items-center px-5 py-2 bg-gray-100 text-gray-600 rounded-lg focus-within:text-gray-600 focus-within:shadow-md">
        <Icon name="search" size="3xl" color="blugraye"></Icon>
        <input
          type="text"
          placeholder="Search"
